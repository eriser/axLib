...
//    }
//
//    void SetFreqModEnvAmount(const double& amount)
//    {
//        _freqModEnvAmount = axClamp<axFloat>(amount, 0.0, 1.0);
//    }
//
//private:
//    MyAudioSynth();
...
public:
    ...
    axEVENT_ACCESSOR(axKnobMsg, OnEnvAmountChange);
...
private:
    ...
    void OnEnvAmountChange(const axKnobMsg& msg);

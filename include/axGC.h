...
public:
	...
	void DrawImageResize(axImage* img, const axPoint& position, const axSize& size, double alpha = 1.0);
	...
	void DrawTexture(GLuint texture, const axRect& rect, axColor color = axColor(0.0, 0.0, 0.0));

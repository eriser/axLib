...
namespace ax
{
    namespace Audio
    {
        ...
        public:
            ...
            BiquadFilter(const unsigned long& sampling_rate,
                         const Type& type = Lowpass,
                         const P& freq = 20000.0,
                         const P& q = 0.7071067811865476,
                         const P& gain = 1.0):
            ...
            void ProcessMonoSample(T* sample)
            {
                if(_active)
                {
                    ...
                    after = _b0 * before + _b1 * _x1 + _b2 * _x2 -
                            _a1 * _y1 - _a2 * _y2;
...
//                        
//                        after_left = (b0 * before_left + b1 * x1 + b2 * x2 -
//                                      a1 * y1 - a2 * y2) / a0;
//                        

...
namespace axAudio
{
    ...
    WaveTable::WaveTable(axAudioBuffer* buffer)
    {
    ...
    void WaveTable::SetWaveformType(const axWaveformType& type)
    {
    ...
    double WaveTable::WaveInterpole(const double& freq,
                                    ...
                                    const double& phase)
    {
        ...
        return axAudio::LineairInterpole<double>(_data[pos], _data[pos + 1], frac);
    }

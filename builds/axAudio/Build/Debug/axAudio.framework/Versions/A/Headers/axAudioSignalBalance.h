...
//            _active(true),
////            _needToInit(true),
//            _sigFilter(sampling_rate, ax::Audio::BiquadFilter<T, P>::Lowpass, 50.0),
//            _cmpFilter(sampling_rate, ax::Audio::BiquadFilter<T, P>::Lowpass, 50.0)
//            {
//                _cmpBuffer = new P*[2];
...
//                        right[i] *= (sig[1] != 0.0 ? cmp[1] / sig[1] : cmp[1]);
//                        
//                        
...
////                        right[i] *= (rpast != 0.0 ? rcmpPast / rpast : rcmpPast);
//                        
////                        std::cout << (past != 0.0 ? cmpPast / past : cmpPast)<< std::endl;
//                    }
//                    
////                    _past = past;
////                    _rpast = rpast;
